(function () {
    ...
    if (isMobileBroswer()) {
        if (window.location.href.indexOf("www") >= 0) {
			...
			var city = window.location.host.split('.')[0];
            window.location.href = window.location.href.replace(city,city + ".m");
        }
    }
})();